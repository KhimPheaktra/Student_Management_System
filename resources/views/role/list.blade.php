...
{{-- Search --}}
  <div class="col-md-10">
    <div class="form-group">
      <form method="get" action="{{ url('/role') }}">
  ...
  <div class="col-md-2">
    <a href="{{url('/role/add')}}" type="button" class="btn btn-primary mb-2">Add New</a>
    </div>
...
<table class="table text-center align-middle mt-2">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                <a href="{{route('role.edit',$role->id)}}" type="button" class="btn btn-warning btn-sm">
                  <i class="fa-solid fa-pen-to-square"></i>
                  Edit
                </a>
                <a href="{{route('role.show',$role->id)}}" type="button" class="btn btn-danger btn-sm">
         ...
         <tr>
          ...
          <h3 class="text-danger ">No Role found</h3>
          </td>
         </tr>
