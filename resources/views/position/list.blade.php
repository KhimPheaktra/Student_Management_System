...
{{-- Search --}}
  ...
  <div class="col-md-2">
    <a href="{{url('/position/add')}}" type="button" class="btn btn-primary mb-2">Add New</a>
    </div>
        ...
        <th scope="col">            <a href="{{ request()->fullUrlWithQuery(['sort' => 'id', 'order' => ($currentSort === 'id' && $currentOrder === 'desc') ? 'asc' : 'desc']) }}"
              class="text-white text-decoration-none">
                ...
                <i class="fa-solid 
                    ...
                    @endif"></i>
            </a>            <a href="{{ request()->fullUrlWithQuery(['sort' => 'id', 'order' => ($currentSort === 'id' && $currentOrder === 'desc') ? 'asc' : 'desc']) }}"
              class="text-white text-decoration-none">
                Id
                <i class="fa-solid 
                    @if ($currentSort === 'id')
    ...
    <tbody>
        ...
        <tr>
            ...
            @role('SuperAdmin', 'Admin')
                <a href="{{route('position.edit',$position->id)}}" type="button" class="btn btn-warning btn-sm">
                  <i class="fa-solid fa-pen-to-square"></i>
                  Edit
                </a>
            @endrole
                <a href="{{route('position.show',$position->id)}}" type="button" class="btn btn-danger btn-sm">
         ...
         <tr>
          ...
          <h3 class="text-danger ">No position found</h3>
          </td>
         </tr>
