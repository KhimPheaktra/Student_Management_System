...
@section('title','Delete Grade')
@section('content')

<h1>Delete Grade</h1>
<div class="container-fluid px-4">
  <ol class="breadcrumb mb-4">
    <li class="breadcrumb-item active">Delete Subject Scores</li>
  </ol>

  <form id="deleteForm" method="POST"
        action="{{ route('grade.delete', ['student' => $selectedStudent->id, 'term_id' => $selectedTerm->id]) }}">
    @csrf
    @method('DELETE')
    ...
    <div class="card mb-4">
      ...
      <div class="card-footer">
        <button type="button" onclick="confirmDelete()" class="btn btn-danger">Delete Scores</button>
      </div>
    </div>
  </form>
